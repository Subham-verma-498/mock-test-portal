...
import {
  indiaBixQuant1Questions,
  indiaBixQuant2Questions,
  indiaBixReasoning1Questions,
  indiaBixVerbal1Questions,
  indiaBixCpp1Questions,
  indiaBixJava1Questions,
  indiaBixCSharp1Questions,
...
async function main() {
  ...
  const testDefs = [
    ...
    {
      title: 'IndiaBIX Quant & Aptitude Test 1',
      category: 'IndiaBIX',
      courseSlug: 'indiabix-test-series',
      description: 'IndiaBIX Quantitative Aptitude Test 1: 15 questions covering Percentages, Profit & Loss, Simple & Compound Interest, Ratio & Proportion, Averages & Ages, Partnership, Alligation, and Discount. (Score out of 30, 2 marks per question)',
      totalQuestions: 15,
      timePerQuestion: 60,
      marksPerQuestion: 2,
      questions: indiaBixQuant1Questions,
    },
    {
      title: 'IndiaBIX Quant & Data Interpretation Test 2',
      category: 'IndiaBIX',
      courseSlug: 'indiabix-test-series',
      description: 'IndiaBIX Quant & Data Interpretation Test 2: 15 questions covering Speed & Distance, Time & Work, Pipes & Cisterns, Permutations, Probability, Boats, Clocks, Calendars, and Data Interpretation. (Score out of 30, 2 marks per question)',
      totalQuestions: 15,
      timePerQuestion: 60,
      marksPerQuestion: 2,
      questions: indiaBixQuant2Questions,
    },
    {
      title: 'IndiaBIX Logical & Analytical Reasoning Test 3',
      category: 'IndiaBIX',
      courseSlug: 'indiabix-test-series',
      description: 'IndiaBIX Logical Reasoning Test 3: 15 questions covering Seating Arrangements, Blood Relations, Syllogisms, Coding-Decoding, Direction Sense, Series, and Arguments. (Score out of 30, 2 marks per question)',
      totalQuestions: 15,
      timePerQuestion: 60,
      marksPerQuestion: 2,
    ...
    {
      title: 'IndiaBIX Verbal Ability & English Test 4',
      category: 'IndiaBIX',
      courseSlug: 'indiabix-test-series',
      description: 'IndiaBIX Verbal Ability & English Test 4: 15 questions covering Synonyms, Antonyms, Sentence Correction, Error Spotting, Idioms & Phrases, Prepositions, Voice, and Speech. (Score out of 30, 2 marks per question)',
      totalQuestions: 15,
      timePerQuestion: 60,
      marksPerQuestion: 2,
    ...
    {
      title: 'IndiaBIX Programming in C & C++ Test 5',
      category: 'IndiaBIX',
      courseSlug: 'indiabix-test-series',
      description: 'IndiaBIX Programming in C & C++ Test 5: 15 questions covering C Pointers, Dynamic Memory Allocation, Smart Pointers, Virtual Destructors, STL Containers, Move Semantics, Diamond Problem, and Operator Overloading. (Score out of 30, 2 marks per question)',
      totalQuestions: 15,
      timePerQuestion: 60,
      marksPerQuestion: 2,
      questions: indiaBixCpp1Questions,
    },
    {
      title: 'IndiaBIX Core Java & OOPs Test 6',
      category: 'IndiaBIX',
      courseSlug: 'indiabix-test-series',
      description: 'IndiaBIX Core Java & OOPs Test 6: 15 questions covering JVM Metaspace, ConcurrentHashMap, Streams API, Exception Hierarchy, String Constant Pool, Volatile Memory, Atomic CAS, Default Methods, and CompletableFuture. (Score out of 30, 2 marks per question)',
      totalQuestions: 15,
      timePerQuestion: 60,
      marksPerQuestion: 2,
      questions: indiaBixJava1Questions,
    },
    {
      title: 'IndiaBIX C# & .NET Platform Test 7',
      category: 'IndiaBIX',
      courseSlug: 'indiabix-test-series',
      description: 'IndiaBIX C# & .NET Platform Test 7: 15 questions covering CLR Architecture, ConfigureAwait(false), Action vs Func, Boxing/Unboxing, LINQ Deferred Execution, GC Generations, Sealed Classes, Expression Trees, and Records. (Score out of 30, 2 marks per question)',
      totalQuestions: 15,
      timePerQuestion: 60,
      marksPerQuestion: 2,
      questions: indiaBixCSharp1Questions,
    },
    {
      title: 'IndiaBIX DBMS & SQL Systems Test 8',
      category: 'IndiaBIX',
      courseSlug: 'indiabix-test-series',
      description: 'IndiaBIX DBMS & SQL Systems Test 8: 15 questions covering Transaction Isolation Levels, B+ Tree Indexing, BCNF Normalization, CROSS JOINs, Write-Ahead Logging (WAL), Clustered Indexes, Triggers, Sharding, and Materialized Views. (Score out of 30, 2 marks per question)',
      totalQuestions: 15,
      timePerQuestion: 60,
      marksPerQuestion: 2,
      questions: indiaBixDbms1Questions,
    },
    {
      title: 'IndiaBIX Computer Networks & Security Test 9',
      category: 'IndiaBIX',
      courseSlug: 'indiabix-test-series',
      description: 'IndiaBIX Computer Networks & Security Test 9: 15 questions covering TCP 3-Way Handshake, CIDR Subnetting (/26), TCP Flow Control, DNS Recursive Queries, HTTP/2 Binary Multiplexing, OSI Layer 3 Routing, NAT/PAT, DNSSEC, BGP, and TLS 1.3. (Score out of 30, 2 marks per question)',
      totalQuestions: 15,
      timePerQuestion: 60,
      marksPerQuestion: 2,
      questions: indiaBixCn1Questions,
    },
    {
      title: 'IndiaBIX OS & Software Engineering (SDLC) Test 10',
      category: 'IndiaBIX',
      courseSlug: 'indiabix-test-series',
      description: 'IndiaBIX OS & SDLC Test 10: 15 questions covering Coffman Deadlock Conditions, Mutex vs Semaphores, Belady Anomaly, SRTF Scheduling, TLB MMU, Thrashing, Agile Scrum Sprint Backlog, Black/White Box Testing, CI/CD, SOLID LSP, and Cyclomatic Complexity. (Score out of 30, 2 marks per question)',
      totalQuestions: 15,
      timePerQuestion: 60,
      marksPerQuestion: 2,
